...
public class BillRVAdapter extends RecyclerView.Adapter<BillRVAdapter.BillViewHolder> {
        ...
        public BillViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.bill_rv_item, parent, false);
